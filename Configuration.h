...
#define STRING_CONFIG_H_AUTHOR "(Calkstein, default config)" // Who made the changes.
...
// from https://reprap.org/forum/read.php?415,880766
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -6, -3.1 }
